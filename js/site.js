...
function renderHome(){
  ...
  document.getElementById("hero-title").innerHTML =
    `${siteContent.heroTitle}<br><em>${siteContent.heroTitleAccent}</em>`;

  document.getElementById("hero-text").textContent = siteContent.heroText;

  document.getElementById("research-heading").textContent =
    siteContent.sectionTitles.research;

  document.getElementById("projects-heading").textContent =
    siteContent.sectionTitles.projects;

  document.getElementById("publications-heading").textContent =
    siteContent.sectionTitles.publications;
      ...
      <div class="pub-main">
        ...
        <div>
          ...
          <div class="pub-links">
            ...
            ${p.journalLink
              ? `<a href="${p.journalLink}" target="_blank" rel="noopener">
                   Journal ↗
                 </a>`
              : ""
            }
            ...
            ${p.hal
              ? `<a href="${p.hal}" target="_blank" rel="noopener">
                   HAL ↗
                 </a>`
              : ""
            }
            ...
            ${p.arxiv
              ? `<a href="${p.arxiv}" target="_blank" rel="noopener">
                   arXiv ↗
                 </a>`
              : ""
            }
            ...
            ${p.zenodo
              ? `<a href="${p.zenodo}" target="_blank" rel="noopener">
                   Zenodo ↗
                 </a>`
              : ""
            }
